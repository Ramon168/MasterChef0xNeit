...
export interface SyrupBarInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DELEGATION_TYPEHASH"
      | "DOMAIN_TYPEHASH"
  ...
  encodeFunctionData(
    functionFragment: "safeSobaTransfer",
    values: [AddressLike, BigNumberish]
  ): string;
...
export interface SyrupBar extends BaseContract {
  connect(runner?: ContractRunner | null): SyrupBar;
  ...
  safeSobaTransfer: TypedContractMethod<
    [_to: AddressLike, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "safeSobaTransfer"
  ): TypedContractMethod<
    [_to: AddressLike, _amount: BigNumberish],
    [void],
    "nonpayable"
