...
export interface SobaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DELEGATION_TYPEHASH"
      | "DOMAIN_TYPEHASH"
...
export interface SobaToken extends BaseContract {
  connect(runner?: ContractRunner | null): SobaToken;
  waitForDeployment(): Promise<this>;

  interface: SobaTokenInterface;
