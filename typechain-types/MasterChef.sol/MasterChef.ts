...
export interface MasterChefInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "soba", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "sobaPerBlock",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "soba", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "sobaPerBlock",
    data: BytesLike
  ): Result;
...
export interface MasterChef extends BaseContract {
  ...
  pendingSoba: TypedContractMethod<
  ...
  soba: TypedContractMethod<[], [string], "view">;

  sobaPerBlock: TypedContractMethod<[], [bigint], "view">;

  startBlock: TypedContractMethod<[], [bigint], "view">;

  syrup: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "soba"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "sobaPerBlock"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "startBlock"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "syrup"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
